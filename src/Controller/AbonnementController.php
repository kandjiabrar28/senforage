...
class AbonnementController extends AbstractController
{
    ...
    {
        return $this->render('abonnement/index.html.twig', ['abonnements' => $abonnementRepository->findAll()]);
    }
    ...
    {
        return $this->render('abonnement/show.html.twig', ['abonnement' => $abonnement]);
    }
    ...
    public function edit(Request $request, Abonnement $abonnement): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('abonnement_edit', ['id' => $abonnement->getId()]);
        }
