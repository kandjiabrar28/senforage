...
class CompteurController extends AbstractController
{
    ...
    {
        return $this->render('compteur/index.html.twig', ['compteurs' => $compteurRepository->findAll()]);
    }
    ...
    {
        return $this->render('compteur/show.html.twig', ['compteur' => $compteur]);
    }
    ...
    public function edit(Request $request, Compteur $compteur): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('compteur_edit', ['id' => $compteur->getId()]);
        }
