...
class ReglementController extends AbstractController
{
    ...
    {
        return $this->render('reglement/index.html.twig', ['reglements' => $reglementRepository->findAll()]);
    }
    ...
    {
        return $this->render('reglement/show.html.twig', ['reglement' => $reglement]);
    }
    ...
    public function edit(Request $request, Reglement $reglement): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('reglement_edit', ['id' => $reglement->getId()]);
        }
